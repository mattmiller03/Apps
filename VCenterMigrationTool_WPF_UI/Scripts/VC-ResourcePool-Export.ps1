...
try {
    ...
    $backupData = Get-ResourcePool | Select-Object Name, Id
    $backupData | ConvertTo-Json | Out-File "$BackupPath\ResourcePools.json"
    "Successfully exported resource pools to $BackupPath"
}
catch {
